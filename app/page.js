      ...
      >
        <div className="w-full text-center lg:text-left lg:w-1/2">
          <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
            ...
            <br className="hidden lg:block" /> finance related issues{" "}
            <span className="font-semibold underline decoration-primary">
              <span ref={el} />
            </span>
          </h1>
          <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
            Welcome to a brighter financial future! Empowering rural communities
            with simple, reliable, and inclusive financial solutions.{" "}
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 hover:bg-blue-200 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                <GoLaw className="mx-auto text-5xl mb-4 text-blue-600" />
                <h3 className=" text-2xl font-semibold text-gray-800 dark:text-gray-200">
                  Government Schemes
                </h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Access information about various government financial schemes
                  and benefits
                </p>
              </div>
            </div>
            ...
            {/* Finance Tracking*/}
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                <FaHandHoldingUsd className="mx-auto text-5xl mb-4 text-green-600" />
                <h3 className=" text-2xl font-semibold text-gray-800 dark:text-gray-200">
                  Finance Tracker
                </h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Discover and apply for government financial assistance
                  programs
                </p>
              </div>
            </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Find and compare loan options tailored to your requirements
                </p>
              </div>
            </div>
            ...
            {/* AI Assistance */}
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center border-2">
                <FaRobot className="mx-auto text-5xl mb-4 text-purple-600" />
                <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
                  AI Assistance
                </h3>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Get intelligent financial advice powered by AI
                </p>
              </div>
            </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Locate the nearest offline center
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-100 dark:bg-gray-900">
        <div className="container px-4 mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            {/* Video 1 */}
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">
                    A brief description of the video goes here. It should be
                    engaging and informative.
                  </p>
                  <Button className="m-2" variant="outline" href="/video-1">
                    Watch Full Video
                  </Button>
                </div>
              </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <Button className="m-2" variant="outline" href="/video-2">
                    Watch Full Video
                  </Button>
                </div>
              </div>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="hover:bg-blue-200 p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <Button className="m-2" variant="outline" href="/video-3">
                    Watch Full Video
                  </Button>
                </div>
              </div>
